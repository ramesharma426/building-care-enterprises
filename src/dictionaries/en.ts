...
export const en = {
  ...
  footer: {
    ...
    registeredNote: `Firm Reg. No. 226 (Hetauda Sub-Metropolitan City) · PAN 607227600`,
  ...
  home: {
    ...
    whyItems: [
      ...
      },
      {
        ...
        desc: "A registered Hetauda firm that knows local builders' and households' needs.",
      },
      {
        title: "Direct Support",
        desc: "Call or WhatsApp us directly for stock checks, pricing, and orders.",
      },
    ],
  ...
  about: {
    ...
    proprietorBody: "Building Care Enterprises is owned and run by Rahul Jalan.",
    valuesHeading: "What We Stand For",
    values: [
      {
        title: "Reliability",
        desc: "Consistent stock and straight answers, every time you call or visit.",
      },
      {
        title: "Local Knowledge",
        desc: "We understand what Hetauda's builders, tradespeople, and households actually need.",
      },
      {
        title: "Fair Dealing",
        desc: "Transparent pricing and honest advice — we'd rather earn a repeat customer than a single sale.",
      },
    ],
    trustHeading: "Registered Business",
    trustItems: [
      "Firm Registration No. 226 — Hetauda Sub-Metropolitan City, Industry Development Section, Makawanpur",
      "PAN: 607227600",
    ],
  },
  products: {
  ...
  contact: {
    ...
    hoursNote:
      "Call ahead to confirm we're open — hours can vary on public holidays.",
    mapHeading: "Find Us",
